      ...
      if (scheduledHighlightedIndexChange.current !== highlightedIndex) {
        ...
        mouseEnterTimer.current = window.setTimeout(() => {
          dispatch({
            ...
            cause: stateChangeTypes.stateChangeTypes.ITEM_MOUSE_ENTER,
            targetId: menuId,
      ...
      if (didMouseMoveOutOfMenu) {
        ...
        if (!isMenuActive) {
          ...
          mouseOutTimer.current = window.setTimeout(() => {
            dispatch({
              type: CascadingMenuAction.CascadingMenuAction.RESET_MENU,
              cause: stateChangeTypes.stateChangeTypes.MOUSE_OUT_OF_MENUS,
              targetId: menuId
            });
          }, delay);
        }
...
exports.useMouseHandlers = useMouseHandlers;
