...
const DefaultVirtualizedItem = react.memo(function DefaultVirtualizedItem2(props) {
...
const ListBase = react.forwardRef(function ListBase2(props, ref) {
  ...
  const defaultItemHeight = Number.parseInt(sizeStackable, 10);
