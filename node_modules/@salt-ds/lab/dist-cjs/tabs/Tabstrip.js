...
var ThemeTabstrip = require('./ThemeTabstrip.css.js');

const withBaseName = core.makePrefixer("saltTabstrip");
const ADD_TAB_LABEL = "Create Tab";
const tabDescriptors = (tabs) => tabs == null ? void 0 : tabs.map(
  (tab) => typeof tab === "string" ? { label: tab } : tab
);
const Tabstrip = react.forwardRef(function Tabstrip2({
  ...
  const [showOverflowMenu, _setShowOverflowMenu] = react.useState(false);
  const setShowOverflowMenu = react.useCallback((value) => {
    _setShowOverflowMenu(value);
  }, []);
  const tabstripId = core.useIdMemo(idProp);
  ...
  const childCount = react.useRef(react.Children.count(children));
  const getChildren = () => {
  ...
  const [innerContainerRef, switchOverflowPriorities] = useOverflowLayout.useOverflowLayout({
    collectionHook,
  ...
  const tabMovedHandler = react.useCallback(
    (fromIndex, toIndex) => {
  ...
  const handleKeydownOverflowMenu = react.useCallback(
    (e) => {
      var _a2, _b;
  ...
  const handleOverflowMenuOpen = react.useCallback(
    (open) => {
      ...
      content.push(
        /* @__PURE__ */ jsxRuntime.jsx(core.Tooltip, {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsx(Dropdown.Dropdown, {
            className: clsx.clsx(withBaseName("overflowMenu"), {
    ...
    if (injectedItem) {
      content.push(
        /* @__PURE__ */ react.createElement(core.Button, {
          ...
          variant: "secondary",
          tabIndex: -1
        }, /* @__PURE__ */ jsxRuntime.jsx(icons.AddIcon, {}))
      );
    }
    return content;
  };
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", {
    ...
    children: [
      ...
      showActivationIndicator ? /* @__PURE__ */ jsxRuntime.jsx(TabActivationIndicator.TabActivationIndicator, {
