...
export declare type MaskFunction = (value: string | undefined) => boolean;
...
export declare const FormattedInput: import("react").ForwardRefExoticComponent<FormattedInputProps & import("react").RefAttributes<HTMLInputElement>>;
