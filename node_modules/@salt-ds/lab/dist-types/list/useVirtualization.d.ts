 ...
 */
export declare type Row<Item> = [number, number, number, CollectionItem<Item>];
...
export declare const useVirtualization: <Item>({ viewportRef, data, itemGapSize, }: VirtualizationHookProps<Item>) => VirtualizationHookResult<Item>;
export {};
