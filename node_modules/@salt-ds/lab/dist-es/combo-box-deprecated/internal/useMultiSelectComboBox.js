...
const useMultiSelectComboBox = (props) => {
  ...
  const handleItemsChange = (newItems) => {
    ...
    onChange == null ? void 0 : onChange(null, uniqueItems);
  };
  ...
  const handleFirstItemSelection = (event) => {
    if (!allowFreeText && event.key === "Enter" && quickSelection) {
      ...
      onSelect == null ? void 0 : onSelect(event, newItem);
      onChange == null ? void 0 : onChange(event, newSelectedItems);
    }
  };
  ...
  const mergedInputProps = {
    ...
    inputProps: {
      ...(_a = inputProps.InputProps) == null ? void 0 : _a.inputProps,
      role: "textbox",
