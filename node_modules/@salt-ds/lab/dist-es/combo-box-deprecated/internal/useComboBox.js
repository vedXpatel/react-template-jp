...
const useComboBox = (props) => {
  ...
  const selectInputValue = (event) => {
    ...
    if (nextItem !== selectedItem) {
      ...
      onChange == null ? void 0 : onChange(event, nextItem);
    }
  };
  ...
  const handleInputChange = (event) => {
    ...
    if (newValue.length === 0) {
      ...
      onChange == null ? void 0 : onChange(event, null);
    }
  ...
  const handleFirstItemSelection = (event) => {
    if (!allowFreeText && event.key === "Enter" && quickSelection) {
      ...
      onSelect == null ? void 0 : onSelect(event, source[0]);
      onChange == null ? void 0 : onChange(event, source[0]);
    }
  };
