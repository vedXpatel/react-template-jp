...
const useClickAway = (nodes, containingDocument, onClickAway, onClick = () => void 0, mouseEvent = "mouseup") => {
  ...
  const handleClickAway = useEventCallback((event) => {
    ...
    const doc = containingDocument || (ownerDocumentNode == null ? void 0 : ownerDocumentNode.ownerDocument);
    if (((_a = doc.documentElement) == null ? void 0 : _a.contains(event.target)) && !isEventComingFromNodes) {
      onClickAway(event);
    }
  });
  useEffect(() => {
