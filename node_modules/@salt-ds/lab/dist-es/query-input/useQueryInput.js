...
function useQueryInput(props, forwardedRef) {
  ...
  const onInputBlur = (event) => {
    ...
    const isFocusWithinBody = (_a = bodyRef.current) == null ? void 0 : _a.contains(relatedTarget);
    if (isFocusWithinBody) {
      return;
    }
    const isFocusWithinPopper = (_b = popperRef.current) == null ? void 0 : _b.contains(relatedTarget);
