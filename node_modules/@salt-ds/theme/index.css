...
.salt-theme[data-mode=light] {
  ...
  --salt-palette-accent-foreground-informative-disabled: var(--salt-color-blue-600-fade-foreground);
}
.salt-theme[data-mode=dark] {
  --salt-palette-accent-background: var(--salt-color-blue-500);
  --salt-palette-accent-background-disabled: var(--salt-color-blue-500-fade-background);
  ...
  --salt-palette-accent-foreground-informative-disabled: var(--salt-color-blue-200-fade-foreground);
}
...
.salt-theme[data-mode=light] {
  ...
  --salt-palette-negative-foreground-disabled: var(--salt-color-red-600-fade-foreground);
  ...
  --salt-palette-negative-background-disabled: var(--salt-color-red-600-fade-background);
  --salt-palette-negative-border: var(--salt-color-red-500);
  --salt-palette-negative-border-disabled: var(--salt-color-red-500-fade-border);
}
.salt-theme[data-mode=dark] {
  --salt-palette-negative-foreground: var(--salt-color-red-200);
  --salt-palette-negative-foreground-disabled: var(--salt-color-red-200-fade-foreground);
  --salt-palette-negative-background: var(--salt-color-red-600);
  --salt-palette-negative-background-hover: var(--salt-color-red-500);
  --salt-palette-negative-background-active: var(--salt-color-red-700);
  --salt-palette-negative-background-disabled: var(--salt-color-red-600-fade-background);
...
.salt-theme[data-mode=light] {
  ...
  --salt-palette-positive-foreground-disabled: var(--salt-color-green-600-fade-foreground);
  ...
  --salt-palette-positive-background-disabled: var(--salt-color-green-600-fade-background);
  --salt-palette-positive-border: var(--salt-color-green-500);
  --salt-palette-positive-border-disabled: var(--salt-color-green-500-fade-background);
}
.salt-theme[data-mode=dark] {
  --salt-palette-positive-foreground: var(--salt-color-green-200);
  --salt-palette-positive-foreground-disabled: var(--salt-color-green-200-fade-foreground);
  --salt-palette-positive-background: var(--salt-color-green-600);
  --salt-palette-positive-background-hover: var(--salt-color-green-500);
  --salt-palette-positive-background-active: var(--salt-color-green-700);
  --salt-palette-positive-background-disabled: var(--salt-color-green-600-fade-background);
...
.salt-theme[data-mode=light] {
  ...
  --salt-palette-warning-foreground-informative-disabled: var(--salt-color-orange-850-fade-foreground);
  ...
  --salt-palette-warning-action-disabled: var(--salt-color-orange-600-fade-background);
  --salt-palette-warning-action-foreground: var(--salt-color-gray-900);
  --salt-palette-warning-action-foreground-disabled: var(--salt-color-gray-900-fade-foreground);
}
.salt-theme[data-mode=dark] {
  ...
  --salt-palette-warning-foreground-informative-disabled: var(--salt-color-orange-400-fade-foreground);
  --salt-palette-warning-action: var(--salt-color-orange-600);
  --salt-palette-warning-action-hover: var(--salt-color-orange-500);
  --salt-palette-warning-action-active: var(--salt-color-orange-800);
  --salt-palette-warning-action-disabled: var(--salt-color-orange-600-fade-background);
...
.salt-theme {
  ...
  --salt-actionable-accented-bold-borderColor-active: var(--salt-palette-interact-border-none);
  --salt-actionable-accented-bold-borderColor-disabled: var(--salt-palette-interact-border-none);
  --salt-actionable-accented-bold-borderColor-hover: var(--salt-palette-interact-border-none);
  --salt-actionable-accented-bold-borderColor: var(--salt-palette-interact-border-none);
  ...
  --salt-actionable-bold-borderColor-active: var(--salt-palette-interact-border-none);
  --salt-actionable-bold-borderColor-disabled: var(--salt-palette-interact-border-none);
  --salt-actionable-bold-borderColor-hover: var(--salt-palette-interact-border-none);
  --salt-actionable-bold-borderColor: var(--salt-palette-interact-border-none);
  ...
  --salt-actionable-background-disabled: var(--salt-palette-interact-background);
  --salt-actionable-background-hover: var(--salt-palette-interact-primary-background-hover);
  --salt-actionable-background: var(--salt-palette-interact-background);
  --salt-actionable-borderColor-active: var(--salt-palette-interact-border-none);
  --salt-actionable-borderColor-disabled: var(--salt-palette-interact-border-disabled);
  --salt-actionable-borderColor-hover: var(--salt-palette-interact-border-none);
  ...
  --salt-actionable-accented-subtle-background-disabled: var(--salt-palette-interact-background);
  --salt-actionable-accented-subtle-background-hover: var(--salt-palette-interact-cta-background-hover);
  --salt-actionable-accented-subtle-background: var(--salt-palette-interact-background);
  --salt-actionable-accented-subtle-borderColor-active: var(--salt-palette-interact-border-none);
  --salt-actionable-accented-subtle-borderColor-disabled: var(--salt-palette-interact-border-none);
  --salt-actionable-accented-subtle-borderColor-hover: var(--salt-palette-interact-border-none);
  --salt-actionable-accented-subtle-borderColor: var(--salt-palette-interact-border-none);
  ...
  --salt-actionable-subtle-background-disabled: var(--salt-palette-interact-background);
  --salt-actionable-subtle-background-hover: var(--salt-palette-interact-primary-background-hover);
  --salt-actionable-subtle-background: var(--salt-palette-interact-background);
  --salt-actionable-subtle-borderColor-active: var(--salt-palette-interact-border-none);
  --salt-actionable-subtle-borderColor-disabled: var(--salt-palette-interact-border-none);
  --salt-actionable-subtle-borderColor-hover: var(--salt-palette-interact-border-none);
  --salt-actionable-subtle-borderColor: var(--salt-palette-interact-border-none);
  ...
  --salt-actionable-negative-bold-borderColor-active: var(--salt-palette-interact-border-none);
  --salt-actionable-negative-bold-borderColor-disabled: var(--salt-palette-interact-border-none);
  --salt-actionable-negative-bold-borderColor-hover: var(--salt-palette-interact-border-none);
  --salt-actionable-negative-bold-borderColor: var(--salt-palette-interact-border-none);
  ...
  --salt-actionable-negative-subtle-borderColor: var(--salt-palette-interact-border-none);
  ...
  --salt-actionable-positive-bold-borderColor-active: var(--salt-palette-interact-border-none);
  --salt-actionable-positive-bold-borderColor-disabled: var(--salt-palette-interact-border-none);
  --salt-actionable-positive-bold-borderColor-hover: var(--salt-palette-interact-border-none);
  --salt-actionable-positive-bold-borderColor: var(--salt-palette-interact-border-none);
  ...
  --salt-actionable-positive-subtle-borderColor: var(--salt-palette-interact-border-none);
  ...
  --salt-actionable-caution-bold-borderColor-active: var(--salt-palette-interact-border-none);
  --salt-actionable-caution-bold-borderColor-disabled: var(--salt-palette-interact-border-none);
  --salt-actionable-caution-bold-borderColor-hover: var(--salt-palette-interact-border-none);
  --salt-actionable-caution-bold-borderColor: var(--salt-palette-interact-border-none);
  ...
  --salt-actionable-caution-subtle-borderColor: var(--salt-palette-interact-border-none);
