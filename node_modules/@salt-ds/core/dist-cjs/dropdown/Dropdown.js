...
function ExpandIcon({ open }) {
  const { CollapseIcon, ExpandIcon: ExpandIcon2 } = SemanticIconProvider.useIcon();
  return open ? /* @__PURE__ */ jsxRuntime.jsx(CollapseIcon, {
    "aria-hidden": true
  }) : /* @__PURE__ */ jsxRuntime.jsx(ExpandIcon2, {
    "aria-hidden": true
  });
}
...
const Dropdown = React.forwardRef(function Dropdown2(props, ref) {
  ...
  const handleKeyDown = (event) => {
    ...
    switch (event.key) {
      case "ArrowDown":
        newActive = (_a2 = getOptionAfter(activeOption)) != null ? _a2 : getLastOption();
        break;
      case "ArrowUp":
        newActive = (_b2 = getOptionBefore(activeOption)) != null ? _b2 : getFirstOption();
        break;
      case "Home":
